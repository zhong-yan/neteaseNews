import time
from neteasenews.spider.spider import datablogspider, collegespider, govspider, \
    gongyispider, mediaspider, rankspider
from neteasenews.spider.mainspider import hotspider, spider, photospider
